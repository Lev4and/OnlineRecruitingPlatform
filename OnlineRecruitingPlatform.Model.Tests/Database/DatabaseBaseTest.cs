...
namespace OnlineRecruitingPlatform.Model.Tests.Database
{
    public class DatabaseBaseTest
    {
        ...
        public DatabaseBaseTest()
        {
            ...
            _dataManager = new DataManager(new EFApplicantCommentAccessTypesRepository(_context), new EFApplicantCommentsOrdersRepository(_context),  new EFIdentityRolesRepository(_context));
        }
    }
}
