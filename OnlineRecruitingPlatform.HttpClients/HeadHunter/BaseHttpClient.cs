...
namespace OnlineRecruitingPlatform.HttpClients.HeadHunter
{
    public class BaseHttpClient
    {
        ...
        {
            _baseUrl = $"https://api.hh.ru/{pathAndQueryUrl}";
            ...
            _client.DefaultRequestHeaders.UserAgent.ParseAdd("OnlineRecruitingPlatform/1.0 (onlinerecruitingplatformapi.u1321851.plsk.regruhosting.ru)");
